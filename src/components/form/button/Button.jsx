		...
		<ThemeProvider theme={theme[variant || "primary"]}>
			<div className={`${parentClass||''} custom-button`}>
				<Wrapper
					...
					{icon && icon}
					<SButton
						className={`w-full  -10 rounded-md leading-tight focus:outline-none focus:shadow-outline text-white ${btnClass && btnClass.includes('py') ? btnClass : "py-3 "+btnClass}`}
						type={type || "button"}
						id={id}
						disabled={disabled}
						style={{ color }}>
